		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item">
			...
			<?php
				...
				{
			?>
				<a class="nav-link active" href="<?=base_url()?>register">Sign Up
			  		<span class="sr-only">(current)</span>
				</a>
			<?php
				}
    ...
    <form class="form">
        <table class="add-course-table">
            ...
            <td>
                ...
                <input type="text" placeholder="Course" class="form__input" />
                </div>
            </td>
            <td>
                <div class="form__group">
                <input type="text" placeholder="Course Name" class="form__input" />
                </div>
            </td>
            <td>
                <div class="form__group">
            ...
            <td>
                <div class="form__group">
                <input type="text" placeholder="Details" class="form__input" />
                </div>
            </td>
            <td>
                <div class="form__group">
