...
<div class="form-container">
    <form method="POST" action="">
        <div class="ip">
            ...
            <input type="text" name="course" class="text-ip" id="course" value="" placeholder="Course">
        </div>
        <div class="ip">
            <label for="coursename">Course Name:</label><br/>
            <input type="text" name="coursename" class="text-ip" id="coursename" value="" placeholder="Course Name">
        </div>
        <div class="ip">
            <label for="link">Link:</label><br/>
            <input type="text" name="link" class="text-ip" id="link" value="" placeholder="Link">
        </div>
        <div class="ip">
            <label for="details">Details:</label><br/>
            <input type="text" name="details" class="text-ip" id="details" value="" placeholder="Details">
        </div>
        <div class="form-btn">
